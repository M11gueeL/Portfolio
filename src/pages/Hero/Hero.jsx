  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
        ...
        <FadeUp delay={0.1} className="group relative inline-flex items-center gap-2 px-5 py-2 mb-8 rounded-full bg-white/60 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 backdrop-blur-md shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 cursor-default">
        ...
        <FadeUp delay={0.4} className="flex flex-wrap items-center justify-center gap-4 mb-12">
        ...
        <FadeUp delay={0.5} className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto">
          <Link
            to="/projects"
