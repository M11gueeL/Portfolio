...
const Contact = () => {
  ...
  return (
    <main className="flex-1 pt-32 pb-8 bg-gradient-to-bl from-blue-400 to-black" id="contact">
      <ScrollToTop />
      <FadeInSection>
        <section className={`mb-12 max-w-2xl sm:mx-8 md:mx-auto bg-gray-50 shadow-lg sm:rounded-lg sm:p-8 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
